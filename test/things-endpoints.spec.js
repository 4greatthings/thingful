    ...
    protectedEndpoints.forEach(endpoint => {
      describe(endpoint.name, () => {
        ...
        describe('GET /api/things/:things_id', () => {
          it(`responds with 401 Missing basic token' when bad method`, () => {
        ...
        describe('GET /api/things/:things_id', () => {
          ...
          it(`responds 401 'Unauthorized request' when no credentials token`, () => {
          ...
          it(`responds 401 'Unauthorized request' when invalid password`, () => {
            const userInvalidCreds = { user_name: testUsers[0], password: 'wrong' }
            return supertest(app)
              .get(endpoint.path)
              .set('Authorization', helpers.makeAuthHeader(userInvalidCreds))
              .expect(401, { error: 'Unauthorized request' })
    ...
    context(`Given an XSS attack thing`, () => {
      ...
      it('removes XSS attack content', () => {
        return supertest(app)
          ...
          .set('Authorization', helpers.makeAuthHeader(testUser)).expect(200)
          .expect(res => {
